    ...
    <AnimateProvider className="max-w-xl mx-auto ">
      ...
      <div className="flex flex-col text-gray-900 space-y-3 text-xs md:text-sm">
        ...
        <div className="flex space-x-5">
          ...
          <p className="font-bold text-yellow-500">{questionData[0].category}</p>
        </div>
      ...
      <button
        ...
        className="flex w-full rounded-full bg-yellow-500 cursor-pointer disabled:bg-yellow-500/50 disabled:cursor-not-allowed p-1 justify-center font-semibold md:font-bold text-base md:text-lg text-center mt-10 text-white hover:bg-yellow-500"
      >
        Start
      </button>
    </AnimateProvider>
